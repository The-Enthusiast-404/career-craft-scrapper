...
const AtlassianLoomUrl = "https://www.atlassian.com/company/careers/all-jobs?search=Loom";

export const scrapeAtlassianLoomJobs = async (browser) => {
  const page = await browser.newPage();
  try {
    await page.goto(AtlassianLoomUrl, { waitUntil: "networkidle0" });
    ...
    logger.info(`Found ${jobs.length} AtlassianLoom jobs. Scraping details...`);
